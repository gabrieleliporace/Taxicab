...
void goto_source(cell*shd,int now,int sem_move);	/*Da implementare, il taxi deve spostarsi da una cella non sorgente a una SO_SOURCES per poi leggere una richiesta*/
